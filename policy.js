document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ko: {
      ...
      "policy-date-prefix": "업데이트: ",
      "policy-date-suffix": "년"
    },
    en: {
    ...
    vi: {
      ...
      "policy-date-prefix": "Cập nhật năm ",
      "policy-date-suffix": ""
    }
  };
  ...
  const policyYear = document.getElementById('policy-year');
  if (policyYear) {
